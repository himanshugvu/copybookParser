...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            if (options.verbose) {
                ...
                System.out.println("Total length: " + result.getTotalLength() + " bytes");
                System.out.println("Number of fields: " + countFields(result.getFields()));
    ...
    private static void showHelp() {
        ...
        System.out.println();
        System.out.println("Parse COBOL copybook files and convert to JSON format");
        System.out.println();
